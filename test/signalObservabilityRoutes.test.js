...
test("signal observability registers five bounded read endpoints", () => {
  ...
  assert.deepEqual([...routes.keys()], ["/high-conviction", "/production-health", "/live-quotes", "/live-market-memory", "/pending-exits"]);
});
